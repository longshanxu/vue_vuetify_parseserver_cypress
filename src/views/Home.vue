 ...
 * @LastEditTime: 2022-06-02 16:12:58
 * @LastEditors: Json.Xu
 * @Description: 
  ...
  <v-container class="fill-height grey lighten-3 pa-0" fluid>
    ...
    <v-bottom-sheet v-model="sheet" persistent>
      <v-sheet class="text-center" height="200px">
        ...
        <v-btn class="mt-6" text color="success" @click="asyncGameData">只同步比赛结果</v-btn>
    ...
    status(val) {
      if (val == 0) {
        ...
        this.datalist = this.list.filter((item) => {
          if (item.yapantouzhu) {
            // return item.qiushutouzhu[0] >= 80 || item.qiushutouzhu[1] >= 80 || item.yapantouzhu[0] >= 80 || item.yapantouzhu[1] >= 80;
            return item.yapantouzhu[0] >= 100 || item.yapantouzhu[1] >= 100;
