...
//https://vipc.cn/i/live/football/date/2021-01-08/prev
//https://vipc.cn/i/live/football/date/2021-01-08/next
...
async function GetTodayMoney() {
    try {
        ...
        // https://vipc.cn/i/live/football/date/today/next
        const options = {
            url: 'https://vipc.cn/i/live/football/date/2021-01-08/prev',
            headers: {
                'User-Agent': 'request'
            },
            gzip: true
