 ...
 * @LastEditTime: 2021-04-14 09:42:26
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2021-04-14/prev
//https://vipc.cn/i/live/football/date/2021-04-14/next
...
async function GetTodayMoney() {
    try {
        ...
        // https://vipc.cn/i/live/football/date/today/next
        const options = {
            url: 'https://vipc.cn/i/live/football/date/2021-04-14/prev',
            headers: {
                'User-Agent': 'request'
            },
            gzip: true
