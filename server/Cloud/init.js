 ...
 * @LastEditTime: 2021-08-29 23:47:29
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2021-11-06/prev
//https://vipc.cn/i/live/football/date/2021-11-06/next
...
async function GetTodayMoney() {
    try {
        ...
        // https://vipc.cn/i/live/football/date/today/next
        const options = {
            url: 'https://vipc.cn/i/live/football/date/2021-11-06/prev',
            headers: {
                'User-Agent': 'request'
            },
            gzip: true
