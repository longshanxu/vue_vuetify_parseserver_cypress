 ...
 * @LastEditTime: 2022-06-05 22:51:07
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2022-06-05/prev
//https://vipc.cn/i/live/football/date/2022-06-05/next
...
async function GetTodayMoney() {
    try {
        ...
        // https://vipc.cn/i/live/football/date/today/next
        const options = {
            url: 'https://vipc.cn/i/live/football/date/2022-06-05/prev',
            headers: {
                'User-Agent': 'request'
            },
            gzip: true
