 ...
 * @LastEditTime: 2023-03-08 20:24:47
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2023-03-08/prev
//https://vipc.cn/i/live/football/date/2023-03-08/next
...
async function GetTodayMoney() {
    try {
        ...
        setTimeout(() => {
            // https://vipc.cn/i/live/football/date/today/next
            const options = {
                url: 'https://vipc.cn/i/live/football/date/2023-03-08/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true,
