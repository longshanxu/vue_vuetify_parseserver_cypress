 ...
 * @LastEditTime: 2021-04-30 17:00:49
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2021-04-30/prev
//https://vipc.cn/i/live/football/date/2021-04-30/next
...
async function GetTodayMoney() {
    try {
        ...
        // https://vipc.cn/i/live/football/date/today/next
        const options = {
            url: 'https://vipc.cn/i/live/football/date/2021-04-30/prev',
            headers: {
                'User-Agent': 'request'
            },
            gzip: true
