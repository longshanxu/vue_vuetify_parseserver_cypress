 ...
 * @LastEditTime: 2020-10-06 22:07:01
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2020-10-06/prev
//https://vipc.cn/i/live/football/date/2020-10-06/next
...
Parse
    ...
    .define("GetTodayMoney", async (request) => {
        try {
            ...
            var datetemp = "2020-10-06";

            const options = {
                url: 'https://vipc.cn/i/live/football/date/2020-10-06/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true
