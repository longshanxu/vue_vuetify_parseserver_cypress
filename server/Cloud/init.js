...
//https://vipc.cn/i/live/football/date/2022-02-20/prev
//https://vipc.cn/i/live/football/date/2022-02-20/next
...
async function GetTodayMoney() {
    try {
        ...
        // https://vipc.cn/i/live/football/date/today/next
        const options = {
            url: 'https://vipc.cn/i/live/football/date/2022-02-20/prev',
            headers: {
                'User-Agent': 'request'
            },
            gzip: true
