 ...
 * @LastEditTime: 2020-09-10 22:07:01
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2020-09-10/prev
//https://vipc.cn/i/live/football/date/2020-09-10/next
...
Parse
    ...
    .define("GetTodayMoney", async (request) => {
        try {
            ...
            var datetemp = "2020-09-10";

            const options = {
                url: 'https://vipc.cn/i/live/football/date/2020-09-10/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true
