...
//https://vipc.cn/i/live/football/date/2022-09-27/prev
//https://vipc.cn/i/live/football/date/2022-09-27/next
...
async function GetTodayMoney() {
    try {
        ...
        setTimeout(() => {
            // https://vipc.cn/i/live/football/date/today/next
            const options = {
                url: 'https://vipc.cn/i/live/football/date/2022-09-27/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true,
