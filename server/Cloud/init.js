 ...
 * @LastEditTime: 2022-08-05 22:07:56
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2022-08-05/prev
//https://vipc.cn/i/live/football/date/2022-08-05/next
...
async function GetTodayMoney() {
    try {
        ...
        setTimeout(() => {
            // https://vipc.cn/i/live/football/date/today/next
            const options = {
                url: 'https://vipc.cn/i/live/football/date/2022-08-05/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true,
