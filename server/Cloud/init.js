 ...
 * @LastEditTime: 2022-08-09 14:35:08
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2022-08-15/prev
//https://vipc.cn/i/live/football/date/2022-08-15/next
...
async function GetTodayMoney() {
    try {
        ...
        setTimeout(() => {
            // https://vipc.cn/i/live/football/date/today/next
            const options = {
                url: 'https://vipc.cn/i/live/football/date/2022-08-15/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true,
