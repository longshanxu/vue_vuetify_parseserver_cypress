 ...
 * @LastEditTime: 2022-06-06 15:28:29
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2022-06-06/prev
//https://vipc.cn/i/live/football/date/2022-06-06/next
...
async function GetTodayMoney() {
    try {
        ...
        // https://vipc.cn/i/live/football/date/today/next
        const options = {
            url: 'https://vipc.cn/i/live/football/date/2022-06-06/prev',
            headers: {
                'User-Agent': 'request'
            },
            gzip: true
