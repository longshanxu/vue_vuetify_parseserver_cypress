 ...
 * @LastEditTime: 2022-07-30 22:07:56
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2022-07-30/prev
//https://vipc.cn/i/live/football/date/2022-07-30/next
...
async function GetTodayMoney() {
    try {
        ...
        setTimeout(() => {
            // https://vipc.cn/i/live/football/date/today/next
            const options = {
                url: 'https://vipc.cn/i/live/football/date/2022-07-30/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true,
