 ...
 * @LastEditTime: 2023-08-11 14:24:12
...
//https://vipc.cn/i/live/football/date/2023-08-11/prev
//https://vipc.cn/i/live/football/date/2023-08-11/next
...
async function GetTodayMoney() {
  try {
    ...
    setTimeout(() => {
      // https://vipc.cn/i/live/football/date/today/next
      const options = {
        url: "https://vipc.cn/i/live/football/date/2023-08-11/prev",
        headers: {
          "User-Agent": "request",
        },
        gzip: true,
