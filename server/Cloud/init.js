 ...
 * @LastEditTime: 2022-08-25 21:52:10
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2022-09-25/prev
//https://vipc.cn/i/live/football/date/2022-09-25/next
...
async function GetTodayMoney() {
    try {
        ...
        setTimeout(() => {
            // https://vipc.cn/i/live/football/date/today/next
            const options = {
                url: 'https://vipc.cn/i/live/football/date/2022-09-25/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true,
