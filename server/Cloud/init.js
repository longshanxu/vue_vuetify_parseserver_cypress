 ...
 * @LastEditTime: 2021-05-13 16:10:33
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2021-05-13/prev
//https://vipc.cn/i/live/football/date/2021-05-13/next
...
async function GetTodayMoney() {
    try {
        ...
        // https://vipc.cn/i/live/football/date/today/next
        const options = {
            url: 'https://vipc.cn/i/live/football/date/2021-05-13/prev',
            headers: {
                'User-Agent': 'request'
            },
            gzip: true
