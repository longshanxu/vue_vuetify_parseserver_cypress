 ...
 * @LastEditTime: 2022-07-24 14:17:11
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2022-07-24/prev
//https://vipc.cn/i/live/football/date/2022-07-24/next
...
async function GetTodayMoney() {
    try {
        ...
        setTimeout(() => {
            // https://vipc.cn/i/live/football/date/today/next
            const options = {
                url: 'https://vipc.cn/i/live/football/date/2022-07-24/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true,
