 ...
 * @LastEditTime: 2020-08-31 22:07:01
 * @LastEditors: Json.Xu
 * @Description: 
...
//https://vipc.cn/i/live/football/date/2020-08-31/prev
//https://vipc.cn/i/live/football/date/2020-08-31/next
...
Parse
    ...
    .define("GetTodayMoney", async (request) => {
        try {
            ...
            var datetemp = "2020-08-31";

            const options = {
                url: 'https://vipc.cn/i/live/football/date/2020-08-31/prev',
                headers: {
                    'User-Agent': 'request'
                },
                gzip: true
